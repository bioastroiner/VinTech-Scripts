...
crafting.addShaped("miniature_black_hole", item('portalgun:item_miniature_black_hole'), [[ore('dustEnderPearl'), ore('dustEnderPearl'), ore('dustEnderPearl')], [ore('dustEnderPearl'), item('minecraft:nether_star'), ore('dustEnderPearl')], [ore('dustEnderPearl'), ore('dustEnderPearl'), ore('dustEnderPearl')]]);
